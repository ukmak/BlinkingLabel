...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/songzy/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'songzy' => 'zhiyong.song@midea.com' }
  s.source           = { :git => 'https://github.com/songzy/BlinkingLabel.git', :tag => s.version.to_s }
